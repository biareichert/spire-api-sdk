...
type Response struct {
	...
	Svids        []*types.X509SVID `protobuf:"bytes,20,rep,name=svids,proto3" json:"svids,omitempty"`
}
...
func (x *Response) GetSvids() []*types.X509SVID {
	if x != nil {
		return x.Svids
	}
	return nil
...
var file_spire_api_proxy_response_proto_rawDesc = []byte{
	...
	0x91, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04,
	...
	0x6c, 0x65, 0x12, 0x2f, 0x0a, 0x05, 0x73, 0x76, 0x69, 0x64, 0x73, 0x18, 0x14, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x19, 0x2e, 0x73, 0x70, 0x69, 0x72, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x74, 0x79,
	0x70, 0x65, 0x73, 0x2e, 0x58, 0x35, 0x30, 0x39, 0x53, 0x56, 0x49, 0x44, 0x52, 0x05, 0x73, 0x76,
	0x69, 0x64, 0x73, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_spire_api_proxy_response_proto_goTypes = []interface{}{
	...
	(*types.X509SVID)(nil), // 2: spire.api.types.X509SVID
}
var file_spire_api_proxy_response_proto_depIdxs = []int32{
	...
	2, // 1: spire.api.proxy.Response.svids:type_name -> spire.api.types.X509SVID
